...
// Public read-only view. Editing remains available through /admin.
...
foreach ($texts as $text) {
    ...
    $textHtml .= '<option value="' . $id . '">' . $id . '</option>';
}
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="public-header">
                <div>
                    <h1 class="h3 mb-1">BDL Manuscript Records</h1>
                    <p class="text-muted read-only-note">Public read-only view</p>
                </div>
                        ...
                        <div id="metaContainer" class="row hide">   <!-- text metadata container -->
                            ...
                            <div id="meta" class="hide">
                                ...
                                <div class="row form-group textmeta mb-3">
                                    ...
                                    <div class="col">
                                        <input type="text" id="author" class="form-control text_editor" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row form-group textmeta mb-3">
                                    ...
                                    <div class="col">
                                        <input type="text" id="pagerange" class="form-control text_editor" readonly>
                                    </div>
                                </div>
 ...
 */           
        // ISOS values are read-only in the public view.
       ...
       // Saving is intentionally unavailable in the public view.
    ...
    function createEditor(id) {
       ...
       CKEDITOR.ClassicEditor.create(document.getElementById(id), {
        ...
        .then( editor => {
            ...
            editor.enableReadOnlyMode('public-view');
        })
        .catch(error => {
            console.error('Could not initialise read-only field ' + id, error);
        });
    }
