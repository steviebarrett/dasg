...
$sth = $dbh->prepare("SELECT id, firstline_c, firstline_untagged FROM fernaig_text WHERE firstline_c IS NOT NULL AND firstline_c != '' ORDER BY firstline_untagged  ASC");
$sth->execute();
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row">       
                ...
                <div class="col-4 mb-5 p-4 border">     <!-- text and mirador container -->
                    ...
                    <div id="text">
                        ...
                        <div class="row form-group mb-3">
                            ...
                            <div id="volume-container" class="col-8">
                        ...
                        <div class="row form-group mb-3">
                            ...
                            <div id="textid-container" class="col-5">
                                <select id="textid" class="form-control">
                                    <option value="">-- select a text --</option>
                                </select>
                            </div>
                            <div class="col-3">
                                <button id="addtext" class="btn btn-danger float-end hide">add text</button>
                            </div>
                        </div>         
                        <div id="addtext-container" class="row form-group mb-3 hide bg-danger-subtle">            
                            <label class="col-4 col-form-label" for="newTextNumber">New text number:</label>
                            <div class="col-2">
                                <input type="text" id="newTextNumber" class="form-control" value="">
                            </div>  
                            <div class="col-3">
                                <button id="createText" class="btn btn-danger">create</button>
                            </div>  
                            <div class="col-3">
                                <button id="cancelAddText" class="btn btn-secondary">cancel</button>
                            </div>          
                        </div>
                        <!--div class="row">
                            <div id="createdTextAlert" class="alert alert-danger alert-dismissible fade text-center" role="alert">
                                <strong>saved</strong>
                            </div>
                        </div-->
                ...
                <div class="col-4 mb-5 p-4 border">     <!-- line edit middle section -->
                    ...
                    <div class="row">
                        ...
                        <div id="pageContainer" class="col-12 mb-3">     <!-- page container -->
                            ...
                            <div class="row form-group">
                                ...
                                <button id="addpage" class="btn btn-danger float-end hide">add page</button>
                                </div>
                                <div id="addpage-container" class="row form-group mb-3 hide bg-danger-subtle">            
                                    <label class="col-4 col-form-label" for="newPageNumber">New page number:</label>
                                    <div class="col-2">
                                        <input type="text" id="newPageNumber" class="form-control" value="">
                                    </div>  
                                    <div class="col-3">
                                        <button id="createPage" class="btn btn-danger">create</button>
                                    </div>  
                                    <div class="col-3">
                                        <button id="cancelAddPage" class="btn btn-secondary">cancel</button>
                                    </div>          
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div id="lineContainer" class="col-12 mb-3">     <!-- line container -->
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-3 form-group mb-3">
                                    <button id="addline" class="btn btn-danger float-end">add line</button>
                                    </div>
                                    <div id="addline-container" class="row form-group mb-3 hide bg-danger-subtle">            
                                        <label class="col-4 col-form-label" for="newLineNumber">New line number:</label>
                                        <div class="col-2">
                                            <input type="text" id="newLineNumber" class="form-control" value="">
                                        </div>  
                                        <div class="col-3">
                                            <button id="createLine" class="btn btn-danger">create</button>
                                        </div>  
                                        <div class="col-3">
                                            <button id="cancelAddLine" class="btn btn-secondary">cancel</button>
                                        </div>         
            ...
            <div class="modal fade" id="savedAlert" tabindex="-1" aria-labelledby="savedModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-sm">
                <div class="modal-content">               
                  <div class="modal-body">
                       <div class="alert alert-danger text-center" role="alert">
                                    <h1 style="color:gray;">saved</h1>
                                </div>
                  </div>
                </div>
              </div>
...
$(function () {
        ...
        $('#addtext').on("click", function (e) {
            ...
            $('#addtext-container').removeClass('hide');
        });
        
        $('#cancelAddText').click(function () {
            $('#addtext').removeClass('hide');
            $('#addtext-container').addClass('hide');
        });
        
        $('#createText').click(function () {
           let textnum = $('#newTextNumber').val();
           ...
           $.getJSON('ajax.php', data, function (response) {
               loadTextsByVolume(volume, response.id);
               $('#addtext').removeClass('hide');
               $('#addpage').removeClass('hide');
               $('#addtext-container').addClass('hide');
               showModalAlert('savedAlert');          
               clear('text');
           })
        });
        ...
        $('#addpage').on("click", function (e) {
            ...
            $('#addpage-container').removeClass('hide');
        });
        
        $('#cancelAddPage').click(function () {
            $('#addpage').removeClass('hide');
            $('#addpage-container').addClass('hide');
        });
        
        $('#createPage').click(function () {
           let pagenum = $('#newPageNumber').val();
           ...
           $.getJSON('ajax.php', data, function (response) {
               $('#addpage-container').addClass('hide');
               showModalAlert('savedAlert');
               loadPageContent(response.id);
               loadPageList(response.id);         
           })
        });
        ...
        $('#addline').on("click", function (e) {
            ...
            $('#addline-container').removeClass('hide');
        });
        
        $('#cancelAddLine').click(function () {
            $('#addline').removeClass('hide');
            $('#addline-container').addClass('hide');
        });
        
        $('#createLine').click(function () {
           let linenum = $('#newLineNumber').val();
           ...
           $.getJSON('ajax.php', data, function (response) {
               ...
               $('#addline').removeClass('hide');
               showModalAlert('savedAlert');
               loadPageContent(pageid, response.id);
               loadLineEditors(response.id);
           })
        });
       ...
       $('#saveText').on('click', function () {
          let number = $('#textid option:selected').html();     
          let data = {
              action:   "saveText",
       ...
       /*
       * Load all texts for volume
        */
       $('#volume').on('change', function () {
          let volume = $(this).val();
          loadTextsByVolume(volume);
          $('#addtext').removeClass('hide');
          $('#addpage').addClass('hide');
       });
       ...
       *    Load Page
       ...
       $('#pageid').on('change', function () {
           ...
           let volume = $('#pageid option:selected').attr('data-volume');
           let textid = $('#pageid option:selected').attr('data-text-id');
           loadTextsByVolume(volume, textid);
           loadText(textid);
           $('#isos').val(isos);
           $('#volume').val(volume);
           $('#textid').val(textid);
...
//                  html += '<li><a href="#" onclick="loadPageContent('+pageid+', '+lineid+');loadLineEditors('+lineid+');">'+ref + '</a> : <div class="resultLine">';
               ...
               html += 'D: ' + result['diplomatic'].replace(qr, '<mark>'+q+'</mark>') + '<br>';
               html += 'V: ' + result['vernacular'].replace(qr, '<mark>'+q+'</mark>')+'<br>';
               html += 'C: ' + result['classical'].replace(qr, '<mark>'+q+'</mark>')+'<br>';
               html += 'T: ' + result['translation'].replace(qr, '<mark>'+q+'</mark>');
               html += '</div></li>';
           });            
       }) 
       .done(function () {
    ...
    function clear(level)
    {
        switch (level) {     
            case "text":
                $('.textmeta').hide();
                $('#pageid').html('<option value="">-- select a page --</option>');
                $('#pageContentContainer').hide();
                $('#manuscript-icon').hide();
            case "page":
                $('#lineid').html('<option value="">-- select a line --</option>');
        //        $('.linecontent').show();
            case "line":
    ...
    function loadTextsByVolume(volume, selectedid = null) {
        $('#textid').html('<option value="">-- select a text --</option>');
        $.getJSON('ajax.php?action=getTextsByVolume&volume=' + volume, function (data) {
              let nextTextNumber = 0;
              if  (data.length > 0) {    
                  $.each(data, function (i, text) {
                     let html = '<option value="'+text.id+'"';
                     if (selectedid == text.id) {
                         html += ' selected';
                     }
                     html += '>'+text.number+'</option>';
                     $('#textid').append(html); 
                     nextTextNumber = parseInt(text.number) + 1;    //default to the next number 
                  });
              $('#newTextNumber').val(nextTextNumber);
              }
          });
    }
    
    function loadPageList(selectedid = null)
    {
        let pageListHtml = '';
        ...
        $.getJSON('ajax.php?action=getPageList', function (data) {
           $.each(data, function (i, page) {
              pageListHtml += '<option';
              pageListHtml += (page.id == selectedid) ? ' selected' : '';
              pageListHtml += ' value="'+page.id+'" data-volume="'+page.volume+'" data-isos-num="'+page.isos+'" data-page-num="'+page.number+'" data-text-id='+page.text_id+'>'+page.volume+' : '+page.number+' . '+page.textnumber;
              pageListHtml += '';
              pageListHtml += '';
              pageListHtml += '</option>'; 
              nextPageNumber = parseInt(page.number) + 1;    //default to the next number
           });
       })
       .done(function (){
    ...
    function loadText(textId) 
    {
       ...
       .done(function (data){
           $('#pageid').append(pageListHtml);
           if (data.length > 0) {               //there are pages for this text
             $('#pageContainer').show();
             loadPageContent(firstPageId);
           } else {                             //no pages saved yet for this text
               return false;
           }
       });
    }
       ...
       $.getJSON('ajax.php?action=getLineList&pid='+pageId, function (data) {
           if (data.length > 0) {
               ...
               $.each(data, function (i, line) {
                  ...
                  // the HTML for the line list 3rd column
                  lineListHtml += '<option '+selected+' value="'+line.id+'">'+line.number+'</option>';
                  let ref = '['+line.pageNum+'.'+line.textNumber+'.'+line.number+']';
                  ...
                  $.each(displayFields, function (key, value) {
                      ...
                      pageContent += '<li class="'+hide+' field '+key+'">' + key.charAt(0).toUpperCase() + ': ' + content[key] + '</li>';
                  })      
                  ...
                  pageContent += '</ul>';
                  nextLineNumber = parseInt(line.number) + 1;
              });
          }
       })
       .done(function (){
           ...
           $('#newLineNumber').val(nextLineNumber);
           if (!lineId) {
   ...
   function SpecialCharactersSimple( editor ) {
    editor.plugins.get( 'SpecialCharacters' ).addItems( 'Simple', [
        ...
        { title: 'modifier letter small b', character: 'ᵇ' },  
        { title: 'modifier letter small c', character: 'ᶜ' },    
        { title: 'modifier letter small d', character: 'ᵈ' }, 
        { title: 'modifier letter small e', character: 'ᵉ' },
        { title: 'modifier letter small h', character: 'ʰ' }, 
        { title: 'modifier letter small i', character: 'ˡ' }, 
        { title: 'modifier letter small m', character: 'ᵐ' }, 
        { title: 'modifier letter small n', character: 'ⁿ' }, 
        { title: 'modifier letter small o', character: 'ᵒ' }, 
        { title: 'modifier letter small r', character: 'ʳ' }, 
        { title: 'modifier letter small t', character: 'ᵗ' },   
        ...
        { title: 'm macron', character: 'm̄'},
        { title: 'n macron', character: 'n̄' },
        { title: 'a macron', character: 'ā' },
        { title: 'e macron', character: 'ē' },
        { title: 'i macron', character: 'ī' },
        { title: 'o macron', character: 'ō' },
