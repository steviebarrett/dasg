...
// generate Javascript to expose the token
...
<head>
  ...
  <title>Language in Lyrics</title>
	...
	<script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.min.js" integrity="sha256-VazP97ZCwtekAsvgPBSUwPFKdrwD3unUfSGVYrahUqU=" crossorigin="anonymous"></script>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="navbar-nav ms-md-auto my-2 my-md-0">
                    ...
                    <!-- <li class="nav-item">
                        <a class="nav-link" title="Admin" href="?m=admin">Admin Dashboard</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" title="FAQ" href="?m=faq">FAQ</a>
                    </li> -->
                </ul>
            </div>
        </div>
